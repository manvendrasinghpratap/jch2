...
<body>
  ...
  <section>
     <div class="container-fluid">
         <form  role="form" method="POST" action="{{ url('/addpharmacy') }}">
                 {{ csrf_field() }}
        <div class="row">
            <div class="col-12 my-4">
                 ...
                 <div class="table-responsive">
                     <table cellpadding="0" cellspacing="0" class="table table-bordered medication2">
                        ...
                        <tr>
                          <td rowspan="7"><input name="startdate[{{ $i }}]" type="date" data-toggle="datepicker"  /></td>
                          <td rowspan="7"><input name="m_d_p_n[{{ $i }}]" type="text" /></td>
                          <td rowspan="7"><input name="dc_date[{{ $i }}]" type="date" data-toggle="datepicker" /></td>
                          <td rowspan="7"><input name="hour[{{ $i }}]" type="text" /></td>                          
                        </tr>  
                         <?php for($j=1; $j<7; $j++){ ?>                    
                        <tr> 
                          <?php for($k=1; $k<32; $k++){ ?>
                          <td><input name="d[{{ $k }}][{{ $i }}][{{ $j }}]" type="text" /></td>
                        <?php } ?>
                        </tr> 
                      <?php } ?>
                ...
                <input type="text" name="p_diagnosis" class="border-bottom-cls w-100" />
                 </div>
                 <div class="row">
                   <div class="col-md-6 col-12 mt-4">
                  <label class="mb-1 font-weight-bold">ALLERGIES:</label>
                  <input type="text" name="p_allergies" class="border-bottom-cls w-100" />
                   </div>
                   <div class="col-md-6 col-12 mt-4">
                  <label class="mb-1 font-weight-bold">DIET:</label>
                  <input type="text" name="p_diet" class="border-bottom-cls w-100" />
                   </div>
                </div>
                  ...
                  <input type="text" name="p_physician" class="border-bottom-cls w-100" />
                   </div>
                   <div class="col-md-6 col-12 mt-4">
                  <label class="mb-1 font-weight-bold">DELEGATING REGISTERED NURSE:</label>
                  <input type="text" name="p_reg_nurse" class="border-bottom-cls w-100" />
                   </div>
                </div>
                ...
                <div class="row">
                  ...
                  <input type="text" name="p_name" class="border-bottom-cls w-100" />
                   </div>
                   <div class="col-md-6 col-12 mt-4">
                  <label class="mb-1 font-weight-bold">DATE:</label>
                  <input type="date" name="p_date" class="border-bottom-cls w-100" data-toggle="datepicker"  />
                   </div>
                </div>
            </div>
